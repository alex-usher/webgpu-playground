        ...
        <div id="body">
            ...
            <div className="editors">
                <div className="vertex-editor">
                    {showCode ? <Editor value={vertexCode} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => {
                        setVertexCode(e.target.value)
                    }} opacity={editorOpacity}/> : <></>}
                </div>
                <div className="fragment-editor">
                    {showCode ? <Editor value={fragmentCode} onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => {
